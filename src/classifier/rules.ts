...
import { categoryDrivers, transmissionChannelsForDrivers } from "../domain/taxonomy.js";
...
const rules: Rule[] = [
  {
    name: "hormuz-war",
    priority: 30,
    requiredAnyPatterns: [/hormuz/i, /red sea/i, /houthis?/i],
    patterns: [/hormuz/i, /red sea/i, /houthis?/i, /iran/i, /tehran/i, /israel/i, /missile/i, /strike/i, /attack/i, /shipping/i, /tanker/i, /blockade/i, /closure/i, /lng/i, /oil/i, /crude/i, /gas/i],
    category: "Hormuz War",
    direct: ["CL", "BRN", "RB", "NG"],
  ...
  },
  {
    ...
    direct: ["FGBL", "FESX", "FDAX", "GC", "NG", "ZW"],
    secondary: ["CL", "BRN", "DXY", "ES", "NQ", "ZC", "ZS", "EU"],
  ...
  {
    name: "policy-international-relations",
    priority: -1,
    requiredAnyPatterns: [
      /foreign policy/i,
    ...
    minMatches: 2,
    category: "Policy/IR",
    direct: ["ES", "NQ", "DXY", "GC", "ZN"],
    secondary: ["CL", "BRN", "EU", "FESX", "FDAX"],
    macroLabels: ["geopolitical risk", "risk-off", "sanctions", "trade war"],
  },
  {
    name: "forex-sovereign-risk",
    priority: 25,
    requiredAnyPatterns: [
      /sovereign/i,
      /default/i,
      ...
      /currency intervention/i,
    ],
    patterns: [
      /eurozone/i, /euro/i, /ecb/i, /france/i, /germany/i, /italy/i,
      /uk/i, /britain/i, /sterling/i, /boe/i,
      /united states/i, /\bus\b/i, /dollar/i, /fed/i,
      /japan/i, /yen/i, /boj/i,
      /canada/i, /canadian/i, /cad/i, /bank of canada/i,
      /australia/i, /australian/i, /aud/i, /reserve bank of australia/i,
      /sovereign/i, /default/i, /devaluation/i, /currency crisis/i, /capital controls?/i,
      /debt crisis/i, /fiscal crisis/i, /emergency budget/i, /money printing/i,
      /quantitative easing/i, /currency intervention/i, /rating downgrade/i,
    ],
    minMatches: 2,
    category: "Forex/Sovereign",
    direct: ["EU", "GU", "UJ", "CAD", "CHF", "AU", "NZD", "DXY"],
    secondary: ["ZN", "FGBL", "GC", "ES", "NQ"],
    macroLabels: ["fiscal risk", "currency intervention", "central bank", "risk-off"],
  },
  {
    name: "us-macro",
    ...
    secondary: ["EU", "GU", "UJ", "CAD", "CHF", "AU", "NZD"],
  ...
  },
  {
    ...
    minMatches: 2,
    category: "Weather/Agri Supply",
    direct: ["NG"],
    secondary: ["DXY", "GC", "ES", "NQ"],
    macroLabels: ["weather / infrastructure", "supply shock", "energy shock", "inflation"],
  },
  {
    ...
    minMatches: 2,
    category: "Weather/Agri Supply",
    direct: ["ZW", "ZC", "ZS", "ZM", "ZL", "ZO", "ZR", "CC", "KC", "SB", "CT", "OJ", "LE", "GF", "HE"],
...
export function classifyNewsItem(item: RawNewsItem): {
  category: Category;
  drivers: import("../domain/types.js").NewsDriver[];
  transmissionChannels: import("../domain/types.js").TransmissionChannel[];
  impact: MarketImpact;
  macroLabels: MacroLabel[];
  status: StatusLabel;
} {
  ...
  return {
    ...
    drivers: unique(matches.flatMap((rule) => categoryDrivers[rule.category])),
    transmissionChannels: transmissionChannelsForDrivers(unique(matches.flatMap((rule) => categoryDrivers[rule.category]))),
    impact: {
